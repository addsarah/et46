    ...
    <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('adduser.create') }}" class="nav-link">Create Guru</a></li>
                <li class="nav-item"><a href="{{ route('adduser.index') }}" class="nav-link">All Guru</a></li>
            </ul>
            <!-- end Menu adm guru -->

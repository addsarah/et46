...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center bg-sl-primary ht-md-100v">
        ...
        <div class="login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white">
            ...
            <div class="tx-center mg-b-60">Silahkan Admin Register Terlebih Dahulu</div>
            ...
            <form action="{{ route('admin.register.create') }}" method="post">
                ...
                <div class="form-group">
                    <input type="email" name="email" required="" class="form-control" name="name"
                        placeholder="Enter email anda, domain @gmail.com ">
                </div><!-- form-group -->
                ...
                <div class="mg-t-40 tx-center">Sudah masuk ke sistem ? <a href="{{ route('admin_login_form') }}"

    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            <div class="sl-page-title">
                <h5>Edit Data Program Tahunan</h5>
            </div>
            <!-- sl-page-title -->
            @include('error.error')
            <form action="{{ route('programtahunan.update', [$programtahunan->id]) }}" method="POST" class="form-horizontal">
                @csrf
                {{ method_field('PUT') }}
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="materi"
                                        value="{{ $programtahunan->materi }}" placeholder="Enter Materi">
                                </div>
                            </div>
                            <!-- col-12 -->
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="alokasi_waktu"
                                        value="{{ $programtahunan->alokasi_waktu }}" placeholder="Jam:Menit">
                                </div>
                            </div>
                            <!-- col-12-->
                            <div class="col-lg-12">
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <select name="semester" class="form-control select2">
                                        <option value="semester_gjl" @if ($programtahunan->semester == 'semester_gjl')  @endif>Semester
                                            Ganjil
                                        </option>
                                        <option value="semester_gnp" @if ($programtahunan->semester == 'semester_gnp')  @endif>Semester
                                            Genap
                                        </option>
                                    </select>
                                </div>
